...
The package includes a DocC catalog at `Sources/LibSignalProtocolSwift/LibSignalProtocolSwift.docc` for Swift Package Manager and Xcode documentation workflows.

The legacy [Jazzy documentation](Documentation) is retained for existing links. It can be regenerated by running the following in the project directory:
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for local verification, strict-concurrency checks, and protocol buffer regeneration notes.
