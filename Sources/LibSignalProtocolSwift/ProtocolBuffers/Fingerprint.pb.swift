...
struct Signal_Fingerprint: @unchecked Sendable {
...
extension Signal_Fingerprint: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularBytesField(value: &self._local) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self._remote) }()
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Signal_Fingerprint, rhs: Signal_Fingerprint) -> Bool {
